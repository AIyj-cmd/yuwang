...
> **版本**:v1.1(2026-05-26)
> **状态**:基于 v3 设计稿验证后的稳定版,可直接用于 Vue 组件落地
>
...
:root {
  ...
  /* 边框与分隔 */
  --color-border: #E8E2D5;
  --color-border-strong: #2B2B2B;  /* 仅用于像素徽章、强 CTA */
...
:root {
  ...
  --border-strong: 2px solid var(--color-border-strong); /* 像素徽章、强 CTA */
}
```
...
- 左侧图标块:44×44px、白底、强边框
- 中间输入区(占位提示):44px 高、白底、强边框、`cursor: text`、粗体主问题 + 次色副提示
- 右侧投放按钮:44px 高、黑底黄字、强边框、扁平阴影、按下偏移动效
...
- 头像:44px,圆角 8px,强边框,根据用户随机分配 mint / coral / primary 三色之一
